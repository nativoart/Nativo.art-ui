      ...
      let ofertar;
        ...
        wallet.signAndSendTransaction({
          ...
          Swal.fire({
            ...
            html:
              '<div class="">' +
              '<div class="font-open-sans  text-base font-extrabold text-white mb-4 text-left uppercase">' +  t("Alerts.approveTokTit") + '</div>' +
              '<div class="font-open-sans  text-sm text-white text-left">' + t("Alerts.approveTokMsg") + '</div>' +
              '</div>',
