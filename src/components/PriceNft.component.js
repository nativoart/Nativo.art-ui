      ...
      {props.sale ? <>{myNFT ?
        ...
        <div className="w-full flex items-center">
          ...
          <div className="w-full flex mt-3">
            <button className="flex  rounded-xlarge w-1/2  h-[50px]  mt-0 mx-2" onClick={() => { buyToken() }} disabled={!enabled}>
              <div className="flex flex-col font-bold h-full text-white  text-center  justify-center shadow-s w-full bg-yellow4 hover:bg-yellowHover active:bg-yellowPressed rounded-md">
            ...
            <button className="flex  rounded-xlarge w-1/2 h-[50px]  mt-0 mx-2 " onClick={() => { handleBidForm() }} >
              <div className="flex flex-col font-bold h-full text-[#0a0a0a]  text-center  justify-center shadow-s w-full border-solid border-2 rounded-md border-[#0a0a0a] hover:bg-[#0a0a0a] active:bg-outlinePressed ">
          ...
          <form
            ...
            className={classNames(bidForm ? "right-0" : "-right-full", "w-full top-1/2 z-50 absolute  grid grid-cols-1 divide-y px-5 py-15 md:flex-row flex-col items-center")}
          >
            <div>
          ...
          {myNFT ? <>
            ...
            {/*NOT on sale and its NOT my NFT*/}
              ...
              <div> 
                <form
                  onSubmit={formik.handleSubmit}
                  className="grid grid-cols-1 divide-y px-5 py-15 md:flex-row flex-col items-center"
                >
                  <div>
                    <div className="flex justify-between ">
                      <div className="w-full flex items-center">
