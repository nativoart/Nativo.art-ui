        ...
        <div className="z-20 mt-6 lg:mt-[16px] ">
          ...
          <Link>
            <button className="flex inline-flex rounded-xlarge lg:w-[267px] h-[50px]">
                ...
                <svg className="fill-current w-[252px] h-[48px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M13 8V2H7v6H2l8 8 8-8h-5zM0 18h20v2H0v-2z"/></svg>
                  <span className="title-font text-white font-open-sans font-normal lg:font-semibold text-base justify-center w-[262px] p-3 uppercase leading-6">{t("Landing.giftnewaccount")} </span>
                </div>
            </button>
            </Link>
          <p className=" lg:mt-[13px] mt-4 lg:text-1xl text-base dark:text-black z-20 font-open-sans font-semibold text-center leading-6 tracking-wider w-[343px] lg:w-[630px]">
            {t("Landing.giftOr")}
          </p>
            <Link>
            <button className="flex inline-flex rounded-xlarge lg:w-[267px] h-[50px]">
                <div className="flex flex-col font-bold h-full text-white text-center justify-center shadow-s w-full bg-yellow4 hover:bg-yellowHover active:bg-yellowPressed rounded-md">
                <svg className="fill-current w-[262px] h-[48px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"></svg>
          ...
          <p className="mt-4 lg:mt-[23px] lg:text-1xl text-base dark:text-black z-20 font-clash-grotesk font-semibold text-center leading-6 tracking-wider w-[283px] lg:w-[630px]">
            {t("Landing.giftown")}
          </p>
          <Link>
            <button className="flex inline-flex rounded-xlarge lg:w-[267px] h-[50px]">
