                ...
                {noCollections ?
                  ...
                  <>
                    <div className="flex flex-col justify-center">
                      ...
                      <a className="relative bg-yellow2 text-white text-center font-bold uppercase text-sm px-6 py-3 rounded-full shadow outline-none focus:outline-none  ease-linear transition-all duration-150 hover:shadow-yellow1 hover:scale-105" href="/collection/state/create">{t('addToken.btnCol')}</a>
                    </div>
                  </>
                }
