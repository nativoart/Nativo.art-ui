          ...
          <Tab.Group>
            <Tab.List className="flex space-x-1 rounded-xl bg-blue-900/20 p-1 mx-5  xl:w-1/2 overflow-scroll lg:overflow-hidden">
              ...
              >
                {t("MyNFTs.creations") +
                  " " +
                  (totalCreations > 1000 ? "(1K+)" : totalCreations)}
              </Tab>
              <Tab
                key={"MisTokens"}
                className={({ selected }) =>
              ...
              >
                {t("MyNFTs.adquisitions") +
                  " " +
                  (totalAdquisitons > 1000 ? "(1K+)" : totalAdquisitons)}
              </Tab>
                  ...
                  <>
                    <div className="px-6 w-full pb-6  flex flex-row-reverse">
                      ...
                      >
                        ...
                        <option value="recentOld">
                          {t("Explore.sortTimeRec")}
                        </option>
                        <option value="oldRecent">
                          {t("Explore.sortTimeOld")}
                        </option>
                      </select>
                    </div>
                          ...
                          <div className="h-full rounded-xl shadow-lg  hover:scale-105 ">
                            <div className="w-[163px] lg:w-[340px] h-[284px]  shadow-lg  rounded-xl">
                              ...
                              <div className="w-[163px] lg:w-[340px] h-[121px] shadow-lg flex  justify-center  items-center ">
                                <p className="w-full h-full text-black  leading-6 text-xl lg:text-4xl font-semibold   font-open-sans text-center px-3 py-2 ">
                                  {t("Profile.add-new")}
                                </p>
                              </div>
                            </div>
