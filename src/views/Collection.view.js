  ...
  //  console.log("🪲 ~ file: Collection.view.js:416 ~ saveCollection ~ type", type)
    ...
    wallet.signAndSendTransaction({
      ...
      Swal.fire({
        ...
        html:
          '<div class="">' +
          '<div class="font-open-sans  text-base font-extrabold text-white mb-4 text-left uppercase">' +  t("Alerts.createColTit") + '</div>' +
          '<div class="font-open-sans  text-sm text-white text-left">' + t("Alerts.createColMsg") + '</div>' +
          '</div>',
  ...
  const uploadFilesPinata = async ()=> {
    ...
    if (!mint.avatar){
      Swal.fire({
       ...
       html:
          '<div class="">' +
          '<div class="font-open-sans  text-base font-extrabold text-white mb-4 text-left uppercase">' +  t("CreateCol.erruploadAvatartitle") + '</div>' +
          '<div class="font-open-sans  text-sm text-white text-left">' + t("CreateCol.erruploadAvatar") + '</div>' +
    ...
    if (!mint.banner){
      Swal.fire({
       ...
       html:
          '<div class="">' +
          '<div class="font-open-sans  text-base font-extrabold text-white mb-4 text-left uppercase">' +  t("CreateCol.erruploadBannertitle") + '</div>' +
          '<div class="font-open-sans  text-sm text-white text-left">' + t("CreateCol.erruploadBanner") + '</div>' +
      ...
      let title = type ? t("CreateCol.EditingCollection") : t("CreateCol.CreatingCollection"); 
      let body = type ? t("CreateCol.EditingCollectionWait") : t("CreateCol.CreatingCollectionWait") ;
      Swal.fire({
        background: '#0a0a0a',
        width: '800',
        html:
          '<div class="">' +
          '<div class="font-open-sans  text-base font-extrabold text-white mb-4 text-left uppercase">' + title + '</div>' +
          '<div class="font-open-sans  text-sm text-white text-left">' +body + '</div>' +
